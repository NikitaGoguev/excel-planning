...
- Публичная сборка по умолчанию предусматривает 20 сотрудников, 100 оценочных/backlog строк, 20 строк активного плана и 20 строк серой зоны; разработчик может изменить эти build-time лимиты в едином конфиге и пересобрать книгу.
